...
Current examples:
- Valid: DonationItem-001.yaml, DonationCollection-001.yaml, DemandSignal-001.yaml, SocialOrganisation-001.yaml, SocialOrganisation-002.yaml
- Invalid: DonationItem-002.yaml (invalid enum), DonationItem-003.yaml (missing required), DonationCollection-002.yaml (invalid enum), SocialOrganisation-002.yaml (invalid enum), SocialOrganisation-003.yaml (missing required)
