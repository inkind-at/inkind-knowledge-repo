# Contributing to inkind-knowledge-repo

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
inkind-knowledge-repo. These guidelines are not strict rules.
...
The inkind-knowledge-repo team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the inkind-knowledge-repo technical leads
...
[issues]: https://github.com/nruemmele/inkind-knowledge-repo/issues/
[pulls]: https://github.com/nruemmele/inkind-knowledge-repo/pulls/
